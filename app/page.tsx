    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12 py-20">
          <div className="max-w-2xl">
            ...
            <p className="text-lg text-sage-100/90 font-light text-white leading-relaxed mb-10 max-w-xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Link
                href="/about"
                className="inline-block px-10 py-4 border border-white/40 text-white text-sm font-medium tracking-wider uppercase hover:bg-white/10 transition-all duration-300 text-center"
              >
                Läs mer om oss
              </Link>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center p-8 luxury-card rounded-sm">
              ...
              <h3 className="text-lg font-medium text-sage-800 mb-3 tracking-wide">Holistisk vård</h3>
              <p className="text-sage-600 text-sm leading-relaxed">
                Vi behandlar hela människan - kropp, sinne och själ - för verklig transformation.
              </p>
            </div>
            ...
            <div className="text-center p-8 luxury-card rounded-sm">
              ...
              <h3 className="text-lg font-medium text-sage-800 mb-3 tracking-wide">Personlig approach</h3>
              <p className="text-sage-600 text-sm leading-relaxed">
            ...
            <div className="text-center p-8 luxury-card rounded-sm">
              ...
              <h3 className="text-lg font-medium text-sage-800 mb-3 tracking-wide">Exklusiv miljö</h3>
              <p className="text-sage-600 text-sm leading-relaxed">
                En fridfull oas designad för att främja avkoppling och välbefinnande.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="lg:pl-8">
              ...
              <p className="text-sage-600 leading-relaxed mb-6">
                Serenity Health Center grundades med en vision - att skapa en fristad
                där varje besökare kan finna lugn, balans och förnyad energi.
              </p>
              <p className="text-sage-600 leading-relaxed mb-10">
                Vårt team av erfarna terapeuter och hälsoexperter arbetar tillsammans
                för att erbjuda dig en skräddarsydd upplevelse som adresserar dina
                unika behov och mål.
              </p>
              <Link
                href="/about"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="group relative overflow-hidden rounded-sm aspect-[3/4]">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <h3 className="text-xl font-semibold text-white mb-2 tracking-wide">Yoga & Meditation</h3>
                <p className="text-white/90 text-sm mb-4 font-medium">
                  Stärk kroppen och lugna sinnet genom medveten rörelse.
                </p>
                <Link href="/services" className="text-gold font-semibold text-sm tracking-wider uppercase hover:text-gold-light transition-colors">
                  Läs mer →
                </Link>
              </div>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-sm aspect-[3/4]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <h3 className="text-xl font-semibold text-white mb-2 tracking-wide">Näring & Hälsa</h3>
                <p className="text-white/90 text-sm mb-4 font-medium">
            ...
            <div className="group relative overflow-hidden rounded-sm aspect-[3/4]">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent"></div>
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <h3 className="text-xl font-semibold text-white mb-2 tracking-wide">Personlig Coachning</h3>
                <p className="text-white/90 text-sm mb-4 font-medium">
      ...
      <section className="py-24 bg-sage-800 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center relative z-10">
          ...
          <div className="flex items-center justify-center gap-4">
            ...
            <span className="text-sage-300 text-sm tracking-wider uppercase">Anna L.</span>
            <div className="w-px h-8 bg-gold/40"></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-4xl mx-auto px-6 lg:px-12 text-center">
          <span className="text-gold text-sm tracking-[0.3em] uppercase">Börja din resa</span>
          <h2 className="text-4xl md:text-5xl font-light text-sage-800 mt-4 mb-6">
            Redo att förändra ditt liv?
          </h2>
          <p className="text-sage-600 text-lg mb-10 max-w-2xl mx-auto">
            Boka en kostnadsfri konsultation och låt oss tillsammans skapa
            en plan för din optimala hälsa och välbefinnande.
          </p>
          <Link
            href="/about"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="md:col-span-2">
              ...
              <p className="text-sage-400 text-sm leading-relaxed max-w-sm">
                Din partner för holistisk hälsa och välbefinnande.
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link href="/about" className="text-sage-400 hover:text-gold text-sm transition-colors">Om oss</Link></li>
              </ul>
            </div>
